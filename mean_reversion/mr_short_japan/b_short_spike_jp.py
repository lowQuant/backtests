...
def main():
    ...
    SCENARIOS.append({
        'label': "Dynamic (Tgt 2%, Max 3%, Lot 100)",
    ...
    if best_eq_df is not None:
        ...
        ax1.yaxis.set_minor_formatter(mticker.NullFormatter()) # Hide minor ticks labels to avoid clutter
        ...
        title_str = (
            f"Short Parabolic Spike JP Summary\n"
